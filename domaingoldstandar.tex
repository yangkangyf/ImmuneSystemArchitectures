...
%%%% Represent in a better and clean way the arrangement organisation
\begin{sidewaystable}
\small
\centering
\begin{center}
...
%Please discuss the results from the probabilities:
% /homes/biertank/cristian/Desktop/Final_Figures_paper_domains/Code/table_final.complete.txt
\begin{figure}[ht!]
  \centering
...
%This is the analysis from table_final.complete.txt
...
%The supplemental file is: table_final.complete.txt
...
%Analize the table: list_annotation_golden_final.table in order to cluster the
% orthology groups
