...
between $\boldsymbol{\mathfrak{G}}$ and the new identified proteins, based on 
the protein domain architectures. In this way $4240$ groups were created and 
to access for orthology relationships between them, \texttt{ProteinOrtho} was 
