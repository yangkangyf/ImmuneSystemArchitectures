...
by the re-assembly from \textit{D.\ vexillum}, which new protein predicton was
...
protein-coding genes. Values $r > 1$ have found on the other species, except
for \texttt{S.\ kowalevskii}, even for the new reported assembly from \textit{D.\ vexillum}.

Next with these subset of proteins, domain architectures could be identified,
...
described on column \textbf{Total Prot.\ ISS}, which was obtained after merging
...
\begin{figure}[ht!]
  ...
  X corresponds to N-terminus and Z to the C-terminus.\TODO{Please change with
  new data}}\label{fig:bigramNet}
\end{figure}
