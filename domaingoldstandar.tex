...
\TODO{Are the resulting heterodomain architectures the product of the combination 
  of protein domains? There is a recurrent protein domain into the architectures?
could be those values statistically significant?}
...
\TODO{Here is possible to make an n-gram analysis in order to identify the 
meaningful domain associations given all the IIS architectures. Maybe is
a good idea to include the sequences from the golden standard, or maybe, 
make this analysis independently.}
\TODO{So, the idea is calculate all the frequencies of bigrams and also,
calculate the counts of those elements, choosing the most frequent}
