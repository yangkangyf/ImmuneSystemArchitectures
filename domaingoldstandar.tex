...
protein domain architectures. In this way $4787$ groups were created and to 
...
or co-orthologous (1:many or many:many) groups. A total of $30782$ 
relations were detected, from them: $52.55$\% reports 1:1 relationships, while
co-orthologs are represented by $47.45$\%. Inside 1:1 relations, exists $3726$
that includes at least one protein from golden species, most of them are relations
that involved $2$ species ($52.20$\%) and the complete distribution reach a maximum
of $15$ species but it was detected only in $1$ orthology group. Then, in order
to identify the phylogenetically distribution of those 1:1 proteins, a presence/absence 
matrix was calculated and phylogenetic tree of studied species
was obtained from \cite{} to calculate evolutionary history of orthologous proteins from IIS
by Dollo parsimony \cite{}.

%Analize results from Trees!

In this way, was identified $2740$ architectures related
